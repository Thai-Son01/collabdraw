...
public class CanvasSyncController {
    ...
    public void reqSyncUserCanvas(@DestinationVariable String roomId, StompHeaderAccessor headers) throws Exception {
        //should get first user in the room (most likely the host)
        String responder = manager.getRoomUsers(roomId).first();
    ...
    public void answerSyncUserCanvas(@DestinationVariable String roomId, StompHeaderAccessor headers) throws Exception{
